        ...
        <div className="space-y-4">
          <div>
            ...
            <ul className="mt-2 divide-y divide-gray-200">
              {Array.isArray(analysis.identifiedRequirements) ? analysis.identifiedRequirements.map((req, index) => (
          ...
          {analysis.suggestedTechStack && typeof analysis.suggestedTechStack === 'object' && (
            <div>
              <h4 className="text-sm font-medium text-gray-500 uppercase tracking-wider">Suggested Tech Stack</h4>
              <div className="mt-2 grid grid-cols-2 gap-2">
                {analysis.suggestedTechStack.frontend && (
                ...
                {analysis.suggestedTechStack.backend && (
                  <div className="col-span-1 bg-gray-50 rounded-md p-2">
                ...
                {analysis.suggestedTechStack.database && (
                  <div className="col-span-1 bg-gray-50 rounded-md p-2">
                ...
                {analysis.suggestedTechStack.hosting && (
                  <div className="col-span-1 bg-gray-50 rounded-md p-2">
          ...
          {analysis.missingInformation && analysis.missingInformation.items && Array.isArray(analysis.missingInformation.items) && analysis.missingInformation.items.length > 0 && (
            <div>
